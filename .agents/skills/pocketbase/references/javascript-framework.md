# PocketBase JavaScript / JSVM

Rendered and extracted from the PocketBase JavaScript / JSVM guides.
...
- `docs/js-overview` -> `src/routes/(app)/docs/js-overview/+page.svelte`
- `docs/js-event-hooks` -> `src/routes/(app)/docs/js-event-hooks/+page.svelte`
- `docs/js-routing` -> `src/routes/(app)/docs/js-routing/+page.svelte`
- `docs/js-database` -> `src/routes/(app)/docs/js-database/+page.svelte`
- `docs/js-records` -> `src/routes/(app)/docs/js-records/+page.svelte`
- `docs/js-collections` -> `src/routes/(app)/docs/js-collections/+page.svelte`
- `docs/js-migrations` -> `src/routes/(app)/docs/js-migrations/+page.svelte`
- `docs/js-jobs-scheduling` -> `src/routes/(app)/docs/js-jobs-scheduling/+page.svelte`
- `docs/js-sending-emails` -> `src/routes/(app)/docs/js-sending-emails/+page.svelte`
- `docs/js-rendering-templates` -> `src/routes/(app)/docs/js-rendering-templates/+page.svelte`
- `docs/js-console-commands` -> `src/routes/(app)/docs/js-console-commands/+page.svelte`
- `docs/js-sending-http-requests` -> `src/routes/(app)/docs/js-sending-http-requests/+page.svelte`
- `docs/js-realtime` -> `src/routes/(app)/docs/js-realtime/+page.svelte`
- `docs/js-filesystem` -> `src/routes/(app)/docs/js-filesystem/+page.svelte`
- `docs/js-logging` -> `src/routes/(app)/docs/js-logging/+page.svelte`

## Overview

- Route: `/docs/js-overview`
- Source Svelte: `src/routes/(app)/docs/js-overview/+page.svelte`
...
onBootstrap((e) => {
    ...
    console.log(name) // The above serialization and isolation context is also the reason why error stack trace line numbers may
    not be accurate.
...
- Route: `/docs/js-event-hooks`
- Source Svelte: `src/routes/(app)/docs/js-event-hooks/+page.svelte`
...
- Route: `/docs/js-routing`
- Source Svelte: `src/routes/(app)/docs/js-routing/+page.svelte`
...
- Route: `/docs/js-database`
- Source Svelte: `src/routes/(app)/docs/js-database/+page.svelte`
...
$dbx.exp("total > {:min} AND total  $dbx.hashExp(pairs)
...
- Route: `/docs/js-records`
- Source Svelte: `src/routes/(app)/docs/js-records/+page.svelte`
...
- Route: `/docs/js-collections`
- Source Svelte: `src/routes/(app)/docs/js-collections/+page.svelte`
...
- Route: `/docs/js-migrations`
- Source Svelte: `src/routes/(app)/docs/js-migrations/+page.svelte`
...
- Route: `/docs/js-jobs-scheduling`
- Source Svelte: `src/routes/(app)/docs/js-jobs-scheduling/+page.svelte`
...
- Route: `/docs/js-sending-emails`
- Source Svelte: `src/routes/(app)/docs/js-sending-emails/+page.svelte`
...
- Route: `/docs/js-rendering-templates`
- Source Svelte: `src/routes/(app)/docs/js-rendering-templates/+page.svelte`
...
- Route: `/docs/js-console-commands`
- Source Svelte: `src/routes/(app)/docs/js-console-commands/+page.svelte`
...
- Route: `/docs/js-sending-http-requests`
- Source Svelte: `src/routes/(app)/docs/js-sending-http-requests/+page.svelte`
...
- Route: `/docs/js-realtime`
- Source Svelte: `src/routes/(app)/docs/js-realtime/+page.svelte`
...
- Route: `/docs/js-filesystem`
- Source Svelte: `src/routes/(app)/docs/js-filesystem/+page.svelte`
...
- Route: `/docs/js-logging`
- Source Svelte: `src/routes/(app)/docs/js-logging/+page.svelte`
