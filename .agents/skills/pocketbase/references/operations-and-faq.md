# PocketBase Operations and FAQ

Rendered and extracted from the production and FAQ pages.
...
- `docs/going-to-production` -> `src/routes/(app)/docs/going-to-production/+page.svelte`
- `faq` -> `src/routes/(app)/faq/+page.svelte`

## Going to production

- Route: `/docs/going-to-production`
- Source Svelte: `src/routes/(app)/docs/going-to-production/+page.svelte`
...
- Create a new environment variable and set a random 32 characters string as its value.
 ...
 e.g. add
            export PB_ENCRYPTION_KEY="L3yDTpGLTgCZLoPo4BafWr8z35cTnmJ1"
...
- Route: `/faq`
- Source Svelte: `src/routes/(app)/faq/+page.svelte`

##### 0. Why?

 PocketBase was created to assist building self-contained applications that can run on
                        a single server without requiring to install anything in addition (see Presentator#183).
 ...
 Please note that PocketBase is neither a startup, nor a business. There is no paid
                        ...
                        maintenance and support beyond what is already available (you can explore the
                            Roadmap
...
- IBM LinuxONE Open Source Software Community Cloud
 ...
 For a more traditional setup you can use any VPS provider that comes with a persistent
                ...
                The
                Going to production guide contains information how to
...
- SaaS, mobile api backend, intranet, etc.
                ...
                There is still room for improvements (I haven't done extensive profiling yet), but
...
##### 8. Can I donate?
 ...
 No. In the past donations were welcomed (I'm very grateful for everyone who contributed) but
                ...
                support at pocketbase.io but only if there are no strings attached.
...
##### 9. Where can I find help for my PocketBase application?
 ...
 You could always look for help in our public
                Discussions board,
                open an issue
                or contact support at pocketbase.io.
